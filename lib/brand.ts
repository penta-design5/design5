...
export const BRAND_KO = "레이어리";
export const BRAND_EN = "LAYERARY";
/** 검색·스니펫용 병기 */
export const BRAND_DISPLAY = `${BRAND_KO}(${BRAND_EN})`;

export const SITE_TAGLINE = "펜타시큐리티 디자인 플랫폼";

/** 루트 기본 description — 한글 브랜드명 포함 */
export const DEFAULT_DESCRIPTION =
  "레이어리(LAYERARY)는 펜타시큐리티의 디자인 작업물을 리뷰하고 리소스를 검색, 편집, 다운로드할 수 있는 중앙 집중식 플랫폼입니다.";

export const DEFAULT_TITLE = `${BRAND_DISPLAY} | ${SITE_TAGLINE}`;

export const OG_TITLE = `${BRAND_KO} | ${SITE_TAGLINE}`;
